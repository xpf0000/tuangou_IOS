...
int rsa_sign_with_private_key_pem(char *message, long message_length
...
int rsa_verify_with_public_key_pem(char *message, long message_length
...
{
    long stringLength = [base64String length];
...
void rsaVerifyString(NSString *stringToVerify, NSString *signature, NSString *publicKeyFilePath, BOOL *verifySuccess)
{
    ...
    long messageLength = [stringToVerify lengthOfBytesUsingEncoding:NSUTF8StringEncoding];
